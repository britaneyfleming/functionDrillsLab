...
//have to call out function by typing the name with parentheses
...
//ternary: const campareNums = (num1, num2) => (num1 > num2) ? num1: num2;
...
let nameGreeting = nameCheck('Baby Yoda')
...
//CODE HERE
let bestMovie = () => `${movie} is the best movie ever!`;

//console.log(bestMovie('Grease'));
...
//CODE HERE
fucntion theEliminator (arr, str) {
